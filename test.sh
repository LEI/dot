...
# run dot sync -u "https://github.com/LEI/dot-git" -d ~/.dot/git
# run dot link -u "https://github.com/LEI/dot-git" -d ~/.dot/git ".gitconfig" ".gitignore"
# run dot template -u "https://github.com/LEI/dot-git" -d ~/.dot/git ".gitconfig.local.tpl"
# run dot line -u "https://github.com/LEI/dot-git" -d ~/.dot/git
# run dot exec -u "https://github.com/LEI/dot-git" -d ~/.dot/git "pwd; ls -la ~"
